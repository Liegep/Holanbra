  ...
  return (
    <footer className="py-24 px-6 md:px-12 border-t border-white/5 bg-background-dark">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-12">
        ...
        <div className="space-y-6">
          <h4 className="text-[10px] font-bold uppercase tracking-[0.3em] text-amber-500/60">{t('navigation')}</h4>
          <ul className="space-y-4 text-[10px] font-bold uppercase tracking-widest text-white/40">
            ...
            <li><Link to="/#imoveis" className="hover:text-amber-400 transition-colors">{t('properties')}</Link></li>
            <li><Link to="/covenant" className="hover:text-amber-400 transition-colors">{t('covenant')}</Link></li>
            <li><Link to="/resident" className="hover:text-amber-400 transition-colors">{t('resident_area')}</Link></li>
          </ul>
        </div>

        <div className="space-y-6">
          <h4 className="text-[10px] font-bold uppercase tracking-[0.3em] text-amber-500/60">{t('contact')}</h4>
          <ul className="space-y-4 text-[10px] font-bold uppercase tracking-widest text-white/40">
            <li className="flex items-center gap-3"><MessageSquare size={12} className="text-amber-500" /> {t('staff_response')}</li>
          </ul>
        </div>

        <div className="space-y-6">
          <h4 className="text-[10px] font-bold uppercase tracking-[0.3em] text-amber-500/60">{t('follow_us')}</h4>
      ...
      <div className="max-w-7xl mx-auto mt-24 pt-8 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-4 text-[10px] font-mono text-amber-500/30 uppercase tracking-[0.2em]">
        <p>&copy; 2026 Holanbra Real Estate SL. {t('rights')}</p>
        <div className="flex items-center gap-8">
          <p>COORD: 128.00 / 45.22 / 2001</p>
          <Link to="/admin" className="opacity-20 hover:opacity-100 transition-opacity">{t('admin')}</Link>
        </div>
      </div>
    </footer>
  );
